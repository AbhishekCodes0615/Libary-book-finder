(() => {
  ...
  const books = [
    ...
    { id: 'b5', title: 'Introduction to Algorithms', author: 'Thomas H. Cormen, Charles Leiserson, Ronald Rivest, Clifford Stein', category: 'Computer Science (CS)', isbn: 'D4', cover: 'Introduction to Algorithms.jpg', desc: 'ntroduction to Algorithms by Cormen, Leiserson, Rivest, and Stein is a comprehensive and widely-used textbook on computer algorithms, often nicknamed "CLRS". It covers a vast range of algorithms and data structures, providing both a rigorous academic resource and a practical reference for professionals. The book presents algorithms in a clear, English-based pseudocode and includes mathematical rigor alongside explanations of engineering and design issues. ' },
